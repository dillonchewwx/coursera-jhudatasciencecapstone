...
Following which, we will create a Corpus with the `tm` package and apply the following two transformations:
...
The created corpus will be saved for subsequent use.
```{r Save Corpus}
saveRDS(combined_Corpus, "../Data/combined_Corpus.rds")
```